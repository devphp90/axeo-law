...
/**
 * This is the model class for table "document_photos".
 *
 * The followings are the available columns in table 'document_photos':
 * @property string $id
 ...
 */
class DocumentPhoto extends CActiveRecord {
